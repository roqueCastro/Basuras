...
public class ApiVolley {
    ...
    public void usuarioAction(
            ...
            final String usu, final String pass, final String telefono,final String direccion, final String rol
    ){
        request = MySingleton.getInstance(context).getRequestQueue();
        stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            @Override
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                paramentros.put("direccion", direccion);
